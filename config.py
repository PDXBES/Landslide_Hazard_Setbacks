...
#TODO = create slope 50 pcnt fl here
...
slope_50pcnt_nowater_copy = arcpy.CopyFeatures_management(slope_50pcnt_nowater_fl, r"in_memory\slope_50pcnt_nowater_copy")
...
slope_source_dict = {
    ...
    50: [slope_50pcnt_nowater_copy, output_50pcnt_gdb]
}
